 ...
 *
 * @deprecated Trusted Core Phase B: this package remains a compatibility input until the Phase C
 * Trusted Safe Range adapter consumes @folio/domain TrustedSafeRangeResult. Do not add new
 * source/freshness/confidence product semantics to this legacy result shape.
 */

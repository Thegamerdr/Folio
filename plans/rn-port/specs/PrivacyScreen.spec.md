...
<View w-5 aria-hidden /> {/_ spacer to center the eyebrow _/}
</View>

{/_ headline block _/}
<View mt-10>
<Text font-display 36px lineHeight 1.05>
Your data, <Text accent upright>your call.</Text> {/_ em is not-italic + accent color _/}
</Text>
...
{/_ action list card (surface + hairline + one inter-row divider) _/}
...
<View hairline-top /> {/_ divide-y: single divider between the two rows _/}
...
<View flex-1 /> {/_ push Melo line to bottom _/}

{/_ Melo footer line _/}

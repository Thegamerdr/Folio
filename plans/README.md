...
- **Melo privacy copy was false** — the "Let Melo see my money" toggle said *"Stays on this
  device"* while it sends the snapshot to an external AI provider, and defaulted ON.

...
export const paper = {
  ...
  ink: '#1B1815', // near-black warm ink
  secondary: '#6A655C', // frozen muted ink
  muted: '#6A655C', // frozen muted ink
  // The single terracotta accent (action / brand accent word / tight-point on the path).
  calm: '#DC5E33', // accent (web --accent)
  accentInk: '#1B1815', // fixed on-accent foreground; never paper/white
  calmStrong: '#B84A24', // text-grade terracotta on paper (web --accent-deep)
    ...
    >
      ...
      <View style={layout.primaryRow}>
        ...
        <View style={layout.primaryArrow} pointerEvents="none">
          <ChevronRight color={disabled ? t.muted : t.canvas} />
        </View>
      </View>

  ...
  return (
    ...
    >
      ...
      {!lens.canAccess('stability') ? (
        <LensLockChip
          moneyMode="stability"
          lockedAfterTrial={Boolean(lens.trialEndedCycleId) && !lens.paidUnlocked}
          onPress={() => nav.go('paywall')}
          palette={t}
        />
        ...
        >
          ...
          <Text style={[s.sampleText, { color: t.calmStrong }]}>make them yours →</Text>
        </Pressable>
      ) : null}
      ...
      <View style={s.card}>
        <View style={[s.cardInner, { backgroundColor: t.surface, borderColor: t.hairline }]}>
          ...
          <View style={s.calendarCtaRow}>
            ...
            >
              <Text style={[s.calendarCtaLabel, { color: t.calmStrong }]}>Before you spend →</Text>
            </Pressable>
            <Pressable
              accessibilityRole="button"
              ...
              style={[s.calendarCta, { backgroundColor: t.inset }]}
            >
              <Text style={[s.calendarCtaLabel, { color: t.calmStrong }]}>Your Safe Zone →</Text>
            </Pressable>
            <Pressable
              accessibilityRole="button"
              ...
              style={[s.calendarCta, { backgroundColor: t.inset }]}
            >
              <Text style={[s.calendarCtaLabel, { color: t.calmStrong }]}>Calendar →</Text>
            </Pressable>
          </View>
        </View>
      </View>
      ...
      >
        ...
        <View style={s.meloPromptBody}>
          ...
          <View style={s.meloPromptMeta}>
            ...
            <Text style={[s.meloPromptCta, { color: t.calmStrong }]}>Ask Melo →</Text>
          </View>
        </View>
      </Pressable>
    </ScrollView>

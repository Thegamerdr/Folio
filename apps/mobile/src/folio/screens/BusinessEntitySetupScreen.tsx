...
export function BusinessEntitySetupScreen({ nav }: { nav: Nav }) {
  ...
  const [step, setStep] = useState<Step>(current ? 'done' : 'kind');
          ...
          <>
            <View style={styles.hero}>
              ...
              <Text style={[styles.intro, { color: t.muted }]}>
                This shapes what the business side asks of you — tax, filings, payroll and how Melo
                talks about money.
              </Text>
            </View>
            ...
            <View style={styles.kindCards}>
              <KindCard
                label="Sole Trader"
                hint="You and the business are one. Self-Assessment, VAT if you're over the threshold."
              ...
              <KindCard
                ...
                hint="Separate legal entity. Corporation Tax, PAYE, dividends, Companies House."
            ...
            <Text style={[styles.changeNote, { color: t.muted }]}>
              You can change this later in Business → Account.
            </Text>
          </>
        ) : null}
        ...
        {step === 'sole' || step === 'ltd' ? (
          <View style={styles.form}>
            <Text style={[styles.eyebrow, { color: t.muted }]}>
              {step === 'ltd' ? 'Limited Company' : 'Sole Trader'}
            </Text>
            <Text accessibilityRole="header" style={[styles.detailHeadline, { color: t.ink }]}>
              {step === 'ltd' ? 'The company basics.' : 'A few details.'}
            </Text>
            <Field
              label={kind === 'ltd' ? 'Company name' : 'Trading name · optional'}
              value={name}
              onChangeText={setName}
              placeholder={kind === 'ltd' ? 'e.g. Carter Design Ltd' : 'e.g. Sam Carter Design'}
            />
            ...
            >
              ...
              <Switch
                ...
                trackColor={{ false: t.inset, true: t.calm }}
              />
            </View>
            ...
            <View style={styles.formActions}>
              <Pressable
                ...
                onPress={() => setStep(current ? 'done' : 'kind')}
                style={({ pressed }) => [
                  styles.backAction,
                  { backgroundColor: t.inset, opacity: pressed ? 0.68 : 1 },
                ]}
              >
                <Text style={[styles.backActionLabel, { color: t.ink }]}>Back</Text>
              </Pressable>
              <Pressable
                accessibilityRole="button"
                disabled={!canSave}
              ...
              >
                <Text style={[styles.saveLabel, { color: t.accentInk }]}>
...
const styles = StyleSheet.create({
  ...
  changeNote: { fontSize: 11.5, marginTop: gap.xl },
  ...
  backActionLabel: { fontSize: 13.5, fontWeight: '700' },
  save: {
    alignItems: 'center',
    borderRadius: radius.md,
    flex: 2,

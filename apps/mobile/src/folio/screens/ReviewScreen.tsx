    ...
    return (
      <Animated.View style={[styles.root, enterStyle, { backgroundColor: t.canvas }]}>
        <View style={[styles.emptyWrap, { paddingTop: insets.top + gap.xxl }]}>
          ...
          >
            <Text style={[styles.primaryLabel, { color: t.accentInk }]}>Add a statement</Text>
          </Pressable>
        </View>
      </Animated.View>
    );
        ...
        <View style={[styles.card, { backgroundColor: t.surface, borderColor: t.hairline }]}>
          ...
          {sourceEvidence !== undefined ? (
            ...
            >
              ...
              <Text style={[styles.sourceEvidenceAction, { color: t.calmStrong }]}>Open</Text>
            </Pressable>
          ) : null}
          ...
          <View style={styles.projectionRow}>
            <View style={[styles.projIcon, { backgroundColor: t.calmSoft }]}>
              <Text style={[styles.projGlyph, { color: t.calmStrong }]}>{isOut ? '−' : '+'}</Text>
            </View>
        ...
        {dupeProposal && !stamped ? (
          ...
          <View style={[styles.dupeCard, { backgroundColor: t.calmSoft, borderColor: t.calm }]}>
            ...
            <View style={styles.dupeRow}>
              ...
              >
                <Text style={[styles.dupePrimaryLabel, { color: t.accentInk }]}>Link them</Text>
              </Pressable>
              <Pressable
                accessibilityRole="button"

...
//   text readers are built later. The file name below is the engine's eventual output — here it is a
//   local sample that REUSES the web source's exact value (no fabricated names).
//

...
export function makeStyles(t: Palette) {
  return StyleSheet.create({
    ...
    pillLead: { color: t.calmStrong, fontWeight: '600' },
    pillGo: {
      color: t.muted,
      fontSize: 12,
      letterSpacing: 1.44,
    ...
    footerCtaAccentLabel: { color: t.accentInk, fontSize: 12.5, fontWeight: '500' },
    footerCta: {
      minHeight: 48,
      borderRadius: radius.xxl,
      backgroundColor: t.surface,
    ...
    stripDayTightest: { color: t.calmStrong, fontWeight: '500' },
    ...
    gridDayTightest: { color: t.calmStrong, fontWeight: '500' },
    ...
    seeOnRouteArrow: { color: t.calmStrong, fontSize: 14 },
  });
}

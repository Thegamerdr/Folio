...
export function InsightsScreen({ nav }: InsightsScreenProps) {
  ...
  const insightsPose = poseForContext('insights', { quietMode });
    ...
    <Animated.View style={[s.root, enterStyle]}>
      ...
      >
        ...
        <View style={s.meloNoteBlock}>
          <MeloLine mood={insightsPose.mood} asleep={insightsPose.asleep} text={retro.meloNote} />
        </View>
        ...
        {cancelSavingsMonthly > 0 ? (
          <View style={s.cancelSavingsBlock}>
            <MeloLine
              mood={insightsPose.mood}
              asleep={insightsPose.asleep}
...
function makeStyles(t: Palette) {
  return StyleSheet.create({
    ...
    streakValue: { color: t.calmStrong, fontStyle: 'normal' },
    ...
    ctaLabel: {
      color: t.canvas, // semantic on-ink label; white fails when dark-mode ink becomes light.
      fontSize: 13.5,
      fontWeight: '500',
    },

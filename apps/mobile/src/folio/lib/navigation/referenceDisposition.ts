...
export const REFERENCE_SCREEN_DISPOSITIONS: readonly ReferenceScreenDisposition[] = [
  ...
  screen('pdf-success', 'personal', 'merge', 'partial', 'pdf-success', 'Shared Intake Result'),
  screen('pdf-fallback', 'personal', 'merge', 'partial', 'pdf-fallback', 'Shared Intake Help'),
  screen('image-success', 'personal', 'merge', 'partial', 'image-success', 'Shared Intake Result'),
  screen('image-fallback', 'personal', 'merge', 'partial', 'image-fallback', 'Shared Intake Help'),
  screen('paste-success', 'personal', 'merge', 'partial', 'paste-success', 'Shared Intake Result'),
  screen('review', 'personal', 'evolve', 'partial', 'review', 'Review / Needs you'),
  screen('today', 'personal', 'evolve', 'live', 'today', 'Today'),
  screen('today-after', 'personal', 'keep', 'live', 'today-after', 'Today post-action state'),
  screen('privacy', 'personal', 'merge', 'partial', 'privacy', 'More / Data & Security'),
  ...
  screen('business-filings', 'business', 'evolve', 'partial', 'business-filings', 'Tax Pack'),
  screen(
    'business-filing-vat',
    'business',
    'merge',

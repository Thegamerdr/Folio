 ...
 *
 * @deprecated Trusted Core Phase B: keep this operational as the compatibility adapter input for
 * Phase C. Do not add new product semantics here; new source/freshness/confidence semantics belong
 * in @folio/domain TrustedSafeRangeResult and the Phase C adapter.
 *

...
const F: Record<FramingSurface, Record<MoneyMode, Framing>> = {
  ...
  cycleClose: {
    survival: { eyebrow: 'Survival', sublabel: 'Review the forecast and what needs attention.' },
    stability: { eyebrow: 'Stability', sublabel: 'Review recorded costs and your buffer.' },
    growth: { eyebrow: 'Growth', sublabel: 'Review the forecast and any pot contribution.' },
    debt: { eyebrow: 'Debt', sublabel: 'Review your debt plan. Record payments separately.' },
    irregular: { eyebrow: 'Irregular', sublabel: 'Review expected income and the dates you know.' },
    household: { eyebrow: 'Household', sublabel: 'Review shared costs and recorded payments.' },
    planning: { eyebrow: 'Planning', sublabel: 'Review recorded progress toward your goals.' },
    optimizer: { eyebrow: 'Optimizer', sublabel: 'Review planned changes and recorded results.' },
    reset: { eyebrow: 'Reset', sublabel: 'Review essentials and leave a note if useful.' },
    lowVis: { eyebrow: 'Looking', sublabel: 'Review the figures you have and what is missing.' },
  },
};

  ...
  return (
    <View style={s.container}>
      <Pressable
        ...
        accessibilityLabel="Your trial ended — Full lenses are locked, everything Free keeps working. See plans or dismiss."
        onPress={() => {
          acknowledgeTrialEnd();
          nav.go('paywall');
        }}
      ...
      >
        ...
        <View style={s.textCol}>
          <Text style={s.title}>Trial ended</Text>
          <Text style={s.body}>Full lenses are locked. Everything Free keeps working.</Text>
        </View>

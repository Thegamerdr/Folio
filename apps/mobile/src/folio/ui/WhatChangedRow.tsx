...
// @reads        transactions, edits, timelineEvents, statementImports, materialChanges,
//               whatChangedSeenISO — via useAppStore; summary maths in lib/whatChanged.ts
//               (pure, tested).
...
export function WhatChangedRow({ nav }: { nav: Nav }) {
  ...
  const summary = useMemo(
    ...
    [transactions, edits, events, imports, materialChanges, seenISO],
  );

...
// A value-free path silhouette: previews compare rendering without presenting example money as
// though it belonged to the current workspace.
const PREVIEW_POINTS: MoneyPathPoint[] = [
  { x: 30, y: 140, label: 'today', value: '' },
  { x: 95, y: 110, label: '', value: '' },
  { x: 165, y: 95, label: '', value: '' },
  { x: 235, y: 175, label: '', value: '' },
  { x: 305, y: 195, label: 'lowest', value: '' },
  { x: 370, y: 150, label: 'payday', value: '' },
];
            ...
            return (
              ...
              >
                ...
                <View style={s.preview}>
                  <MoneyPathChart points={PREVIEW_POINTS} style={style} pressure="soft" />
                </View>
              </Pressable>
            );
          })}

/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: aa5a1c71ce97fe111ef1af0ec672f42c)
// Runtime types generated with workerd@1.20260714.1 2026-07-14 nodejs_compat
interface __BaseEnv_Env {
  ENTITLEMENTS: KVNamespace;
  VERIFY_SOURCE_RATE_LIMITER: RateLimit;
  VERIFY_PURCHASE_RATE_LIMITER: RateLimit;
  PACKAGE_NAME: 'com.melomoney.app';
  GOOGLE_TOKEN_URI: 'https://oauth2.googleapis.com/token';
  ENTITLEMENT_ISSUER: 'https://melo-billing-entitlements.tgdroppin.workers.dev';
  ENTITLEMENT_AUDIENCE: 'com.melomoney.app';
  ENTITLEMENT_SIGNING_KEY_ID: 'melo-billing-ed25519-2026-07';
  ENTITLEMENT_SIGNING_PUBLIC_JWK: '{"crv":"Ed25519","x":"OKponTUZ9ZP1APZpvUeUK5BmKmlJm8FZQ5IDAd92HL8","kty":"OKP"}';
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      ...
      | 'ENTITLEMENT_SIGNING_PUBLIC_JWK'
      | 'BILLING_PUBLIC_VERIFICATION_ENABLED'
      | 'ALLOWED_ORIGINS'
    >
  > {}
}

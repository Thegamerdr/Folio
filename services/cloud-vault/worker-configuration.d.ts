/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8477d994e43adc4f4e651e0e332a1501)
// Runtime types generated with workerd@1.20260625.1 2026-07-14 nodejs_compat
interface __BaseEnv_Env {
  VAULTS: KVNamespace;
  CLERK_ISSUER: 'https://united-giraffe-33.clerk.accounts.dev';
  CLERK_JWKS_URL: 'https://united-giraffe-33.clerk.accounts.dev/.well-known/jwks.json';
  MAX_BACKUP_BYTES: '4194304';
  ALLOWED_ORIGINS: '';
  PUBLIC_ACCOUNT_DELETION_URL: '';
  SYNC_WORKSPACES: DurableObjectNamespace<import('./src/index').SyncWorkspaceDurableObject>;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./src/index');
    durableNamespaces: 'SyncWorkspaceDurableObject';
  }

/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 03a556ec8e77ef77558aaa9ebd79414f)
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, 'CLERK_ISSUER' | 'CLERK_JWKS_URL' | 'MAX_BACKUP_BYTES' | 'ALLOWED_ORIGINS'>
  > {}
}

...
| 8 — Personal launch                          | Complete offline local-first Personal journey and one Melo host                                                     | Major Personal screens and deterministic flows exist, but master-plan journey consolidation, all shared states and Android+iPhone completion evidence are open                                                                                                               | **Partial**                                                                |
| 9 — accounts, sync, provider and entitlement | Real auth/recovery, encrypted sync, Money Sources, billing lifecycle, ownership controls                            | Local/contract foundations and some services exist; real provider/account/store lifecycle and production deletion/recovery evidence remain open                                                                                                                              | **Partial**                                                                |

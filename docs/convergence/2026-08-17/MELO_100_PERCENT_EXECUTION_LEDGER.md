...
| 8 — Personal launch                          | Complete offline local-first Personal journey and one Melo host                                                     | Major Personal screens and deterministic flows exist. The GBP-only launch boundary now fails closed across manual accounts, restored legacy state, file/paste/photo/PDF/OCR intake, canonical projections and money totals. Master-plan journey consolidation, all shared states and Android+iPhone completion evidence remain open. | **Partial**                                                                |
| 9 — accounts, sync, provider and entitlement | Real auth/recovery, encrypted sync, Money Sources, billing lifecycle, ownership controls                            | Local/contract foundations and some services exist. Provider mapping and local account selection now exclude non-GBP accounts honestly, but real provider/account/store lifecycle and production deletion/recovery evidence remain open.                                                                                             | **Partial**                                                                |

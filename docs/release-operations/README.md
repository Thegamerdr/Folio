...
Current state (31 August 2026; candidate revalidated against the current release control plane):
...
- The release-candidate tabletop addendum is recorded in
  `release-candidate-tabletop-addendum-2026-08-31.md`.
